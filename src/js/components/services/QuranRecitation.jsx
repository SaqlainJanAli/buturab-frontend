...
const QuranRecitation = () => {
  ...
  return (
    <>
      <Container>
        {/* <Grid> */}
        <Panel bordered shaded style={{ margin: "20px" }}>
          <Col xs={18} md={18}>
            <br />
            ...
            <ol>
              <li>
                ...
                <ButtonGroup>
                  ...
                  <IconButton icon={<FaQuestion />} appearance="primary">
                    {/* <Icon as={FaQuestion} pulse size="2em" /> */}
                  </IconButton>
                </ButtonGroup>
                {modalAdmission}
                <br />
          ...
          <Col xs={6}>
            ...
            >
              <div style={{ display: "flex", justifyContent: "center" }}>
                {/* <FacebookEmbed
                  url="https://www.facebook.com/saqlain.jan.alii/posts/123459789987"
                  width={550}
                /> */}
